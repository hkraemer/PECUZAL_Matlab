...
% data_sample:        Number of considered fiducial points as a fraction of 
%                     input time series length (Default is data_sample = 0.2)
...
for ks = 1:NNN
    ...
    % find nearest neighbours for the fiducial point
